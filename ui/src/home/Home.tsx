...
function Home() {
    return <div className={"pt-2 pb-3"}>
        <Jumbotron/>
        <div className={"p-3 mt bg-blue-200 dark:bg-blue-800 rounded-2 shadow-md"}>
            <div className={"text-lg fw-bold dark:text-white"}>
            ...
            <div className={"text-lg fw-bold mt-2 dark:text-white"}>
