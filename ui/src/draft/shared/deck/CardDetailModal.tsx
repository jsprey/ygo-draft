...
function CardDetailModal(props: CardDetailModalProps) {
    ...
    const badgeCN = classNames("mr-1 p-2 rounded-lg bg-secondary-light border border-border text-dark")
    ...
    return <Modal show={props.isShowing}
        ...
        <div className={"flex"}>
            ...
            <div className={"w-[72%]"}>
                ...
                <p className={"p-2 mb-0 mt-2 ml-2 font-semibold bg-light-3 dark:bg-dark-3 border-l border-t border-r border-border"}>Description:</p>
                <div className={"p-2 mb-1 ml-2 bg-light-1 dark:bg-dark-1 border-l border-b border-r border-border"}>{card.desc}</div>
                <p className={"p-2 mb-0 mt-2 ml-2 font-semibold bg-light-3 dark:bg-dark-3 border-l border-t border-r border-border"}>Included in
                    the following Sets:</p>
                <div className={"p-2 mb-1 ml-2 bg-light-1 dark:bg-dark-1 dark:text-white border-l border-b border-r border-border"}>
