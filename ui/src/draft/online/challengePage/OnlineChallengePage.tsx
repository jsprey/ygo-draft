...
export type OnlineChallengeState = {
    friendID: number,
    friendName: string
}

function OnlineChallengePage() {
    ...
    function sendChallenge(settings: DraftSettings, state: OnlineChallengeState) {
    ...
    if (!location.state) {
        ...
        const state = location.state as OnlineChallengeState;
        return <div>
