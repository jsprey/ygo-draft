...
function DraftHeader(props: DraftHeaderProps) {
    ...
    const settingsHeaderCN = classNames("flex-grow pl-2", "rounded-tl rounded-tr", settingCollapsed ? "rounded-bl rounded-br" : "", "border border-border", "bg-gray-200 dark:bg-gray-600")
    const settingsBodyCN = classNames("p-2", "rounded-bl rounded-br", "border-l border-b border-r  border-border", "bg-lightI dark:bg-dark")
